...
go run ./scripts/apply_sql_migration sql/20260924_enforce_pulsa24jam_catalog.sql
if [[ -n "${PULSA24JAM_H2HR_CATALOG_FILE:-}" && -f "${PULSA24JAM_H2HR_CATALOG_FILE:-}" ]]; then
  go run ./scripts/import_pulsa24jam_h2hr_catalog -file "$PULSA24JAM_H2HR_CATALOG_FILE"
fi
