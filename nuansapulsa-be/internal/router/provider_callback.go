...
func ProviderCallbackRouter(mux *http.ServeMux, deps ProviderCallbackDeps) {
	...
	mux.HandleFunc("/v1/webhook/nuansapulsa4jam", helper.ProviderIPGuard("nuansapulsa4jam", ctrl.CallbackPulsa24Jam))
	...
	mux.HandleFunc("/webhook/nuansapulsa4jam", helper.ProviderIPGuard("nuansapulsa4jam", ctrl.CallbackPulsa24Jam))
