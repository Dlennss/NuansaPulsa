...
// EnsureNuansaPulsaDepositBank keeps the public deposit account available after
// deployment, including installations where SQL migrations are applied later.
func (r *BankRepository) EnsureNuansaPulsaDepositBank(ctx context.Context) error {
	if r == nil || r.db == nil {
