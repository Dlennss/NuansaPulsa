...
export function PulsaEntryCard({
  ...
  return (
    <section className="overflow-hidden rounded-[22px] border border-red-100/80 bg-white shadow-[0_18px_42px_rgba(99,24,34,0.10)]">
      <div className="bg-linear-to-r from-red-50 via-white to-orange-50 px-4 py-4">
        <div className="flex items-center gap-3">
          <div className="grid h-11 w-11 place-items-center rounded-2xl bg-white text-[#e50b18] shadow-[0_10px_22px_rgba(215,7,23,0.14)] ring-1 ring-red-100">
      ...
      <div className="space-y-4 px-4 py-4">
        <div className="relative">
          <input
            ...
            className={`h-12 w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 pl-11 text-sm font-semibold text-slate-900 shadow-[0_8px_22px_rgba(15,23,42,0.04)] placeholder:text-slate-400 focus:border-[#e50b18] focus:bg-white focus:outline-none focus:ring-2 focus:ring-red-100 ${detectedBrand ? "pr-14" : ""}`}
          />
        ...
        <div className="grid grid-cols-[1fr_auto] items-stretch gap-2">
          <div className="relative flex-1">
            <input
              ...
              className="h-12 w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 pl-11 text-sm font-semibold text-slate-900 shadow-[0_8px_22px_rgba(15,23,42,0.04)] placeholder:text-slate-400 focus:border-[#e50b18] focus:bg-white focus:outline-none focus:ring-2 focus:ring-red-100"
            />
          ...
          <button
            ...
            className="inline-flex h-12 min-w-20 items-center justify-center rounded-2xl bg-linear-to-r from-[#e50914] to-[#ff6a00] px-4 text-sm font-black text-white shadow-[0_12px_24px_rgba(229,9,20,0.22)] transition hover:opacity-95 disabled:cursor-not-allowed disabled:opacity-40"
          >
            Beli
          </button>
        </div>
