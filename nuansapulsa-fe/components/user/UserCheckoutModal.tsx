...
function buildGuestIdentity(dest: string) {
  ...
  return {
    guestNama: "Guest NuansaPulsa",
    guestEmail: phone ? `guest-${phone}@nuansapulsa.local` : "guest@nuansapulsa.local",
    guestPhone: phone,
  };
}
...
export function UserCheckoutModal({
  ...
  function handleDownloadProof() {
    void (async () => {
      ...
      doc.setFontSize(11);
      doc.text("NuansaPulsa - QRIS Payment Receipt", centerX, 61, { align: "center" });
      doc.setFontSize(10);
      ...
      doc.setFont("helvetica", "normal");
      doc.text("Dokumen ini dibuat otomatis oleh sistem NuansaPulsa dan valid sebagai bukti pembayaran.", 56, finalY + 58);
