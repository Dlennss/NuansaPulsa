...
const kilatLevels = [
  {
    ...
    name: "Nuansa Start",
    short: "Start",
    image: "/agent-levels/nuansa-start-badge.png",
  ...
  },
  {
    ...
    name: "Nuansa Plus",
    short: "Plus",
    image: "/agent-levels/nuansa-plus-badge.png",
  ...
  },
  {
    ...
    name: "Nuansa Elite",
    short: "Elite",
    image: "/agent-levels/nuansa-elite-badge.png",
    bg: "from-purple-50 via-white to-yellow-100",
    accent: "bg-purple-600",
    text: "text-purple-700",
    desc: "Level tertinggi NuansaPulsa setelah agent menyelesaikan 5 pengajuan tepat waktu. Limit maksimal Rp 2.000.000.",
    benefits: [
      ...
      <section className={`relative min-h-[520px] overflow-hidden bg-linear-to-br ${activeLevel.bg} px-4 pt-5 text-slate-700`}>
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            <h1 className="truncate text-lg font-semibold text-slate-700">NuansaPulsa Level</h1>
          </div>
        </div>
