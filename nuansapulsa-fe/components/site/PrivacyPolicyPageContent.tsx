...
const principles = [
  {
    ...
    items: [
      "NuansaPulsa menyediakan pulsa, paket data, token listrik, e-wallet, voucher game, PPOB, dan produk digital lain yang tersedia di aplikasi.",
  ...
  },
  {
    ...
    items: [
      "Dilarang menggunakan NuansaPulsa untuk penipuan, pencucian uang, penyalahgunaan identitas, manipulasi transaksi, atau aktivitas yang melanggar hukum.",
      "NuansaPulsa dapat menunda transaksi, membatasi fitur, atau menonaktifkan akun jika ditemukan aktivitas mencurigakan atau pelanggaran ketentuan.",
    ],
  },
];
        ...
        <div className="overflow-hidden rounded-[28px] border border-white/70 bg-linear-to-br from-[#0f6fcb] via-[#1576d0] to-[#2f92df] px-5 py-6 text-white shadow-[0_24px_60px_rgba(15,111,203,0.22)]">
          <div className="max-w-[20rem]">
            ...
            <h1 className="mt-3 text-balance text-[30px] font-black leading-[1.02] tracking-tight">
              Aturan penggunaan layanan NuansaPulsa.
            </h1>
            <p className="mt-4 text-sm leading-6 text-white/90 text-justify">
              Ketentuan ini menjelaskan cara menggunakan produk digital, saldo, akun agent, program kredit, dan fitur pendampingan marketing di NuansaPulsa.
            </p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <h2 className="mt-1 text-xl font-black tracking-tight text-slate-950">
                NuansaPulsa menjaga transaksi tetap aman, jelas, dan bertanggung jawab
              </h2>
            </div>
          </div>
      ...
      <section className="relative px-4 pb-4">
        <div className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
          <div className="flex items-start gap-3">
            ...
            <h2 className="mt-1 text-xl font-black tracking-tight text-slate-950">
                Dengan memakai layanan NuansaPulsa, Anda menyetujui ketentuan penggunaan ini
              </h2>
            </div>
          </div>
          ...
          <div className="mt-4 space-y-3 text-sm leading-6 text-slate-600 text-justify">
            <p>
              NuansaPulsa dapat memperbarui ketentuan ini mengikuti perubahan fitur, proses layanan, dan kebutuhan keamanan.
              Versi terbaru akan dipublikasikan pada halaman ini.
            </p>
            <p>
              Pengguna dianggap menyetujui perubahan ketentuan apabila tetap menggunakan akun dan layanan NuansaPulsa setelah pembaruan dipublikasikan.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <h2 className="mt-2 text-xl font-black tracking-tight">
                Hubungi NuansaPulsa jika Anda membutuhkan bantuan terkait akun, transaksi, atau ketentuan layanan
              </h2>
            </div>
          </div>
