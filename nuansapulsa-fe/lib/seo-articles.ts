...
export const SITE_URL =
  ...
  "https://nuansapulsa.local";

export const CANONICAL_SITE_URL = "https://nuansapulsa.local";
export const DEFAULT_OG_IMAGE_URL = `${CANONICAL_SITE_URL}/images/logo-nuansapulsa.svg`;
...
export const seoArticles: SeoArticle[] = [
  {
    ...
    description: "Panduan isi pulsa online Telkomsel, Indosat, XL, Axis, Smartfren, dan Tri lewat NuansaPulsa dengan alur yang cepat dan mudah dipahami.",
    ...
    sections: [
      {
        ...
        body: [
          ...
          "NuansaPulsa cocok untuk kebutuhan ini karena pengguna bisa langsung masuk ke kategori pulsa tanpa harus melewati langkah yang rumit.",
        ],
      },
      {
        heading: "Langkah isi pulsa di NuansaPulsa",
        body: [
    ...
    faqs: [
      { question: "Apakah semua operator besar tersedia?", answer: "Ya. NuansaPulsa mendukung operator utama seperti Telkomsel, Indosat, XL, Axis, Smartfren, Tri, dan brand terkait yang aktif di katalog." },
  ...
  },
  {
    ...
    description: "Panduan membeli paket data harian, mingguan, dan bulanan melalui NuansaPulsa dengan grup produk yang lebih jelas dan mudah dipilih.",
    ...
    sections: [
      {
        ...
        body: [
          ...
          "Di NuansaPulsa, grup produk dan judul kartu yang lebih ringkas membuat pembeli lebih cepat memahami isi paket seperti 1 GB 7 Hari atau 12 GB 30 Hari.",
        ],
      },
      {
  ...
  },
  {
    ...
    title: "Cara Top Up DANA, OVO, GoPay, dan LinkAja di NuansaPulsa",
    description: "Panduan top up e-wallet melalui NuansaPulsa, termasuk nominal tetap, bebas nominal, dan cara membaca biaya secara lebih jelas.",
  ...
  },
  {
    ...
    description: "Panduan top up game melalui NuansaPulsa untuk pemain dan penjual, dengan alur yang lebih ringkas dan fokus ke produk inti.",
    ...
    sections: [
      ...
      {
        heading: "Cara top up game di NuansaPulsa",
        body: [
  ...
  },
  {
    ...
    description: "Panduan membeli token listrik PLN melalui NuansaPulsa, termasuk cara membaca grup promo, standar reply, dan full reply.",
  ...
  },
  {
    ...
    description: "Panduan membayar tagihan listrik atau PLN pascabayar melalui NuansaPulsa dengan proses yang mudah dipahami pelanggan rumah tangga maupun agen PPOB.",
  ...
  },
  {
    ...
    description: "Panduan membayar BPJS Kesehatan online lewat NuansaPulsa untuk kebutuhan pribadi, keluarga, dan layanan PPOB.",
    ...
    hero: "Kategori BPJS memperluas layanan NuansaPulsa dari produk harian ke kebutuhan bulanan yang lebih wajib.",
    ...
    sections: [
      {
        ...
        body: [
          ...
          "Layanan BPJS juga memperluas citra NuansaPulsa dari top up harian menjadi platform pembayaran yang lebih lengkap.",
        ],
      },
      {
        heading: "Cara bayar BPJS di NuansaPulsa",
        body: [
  ...
  },
  {
    ...
    description: "Panduan membayar tagihan PDAM secara online melalui NuansaPulsa untuk pelanggan rumah tangga dan usaha PPOB.",
    ...
    hero: "Layanan PDAM membantu NuansaPulsa menjangkau kebutuhan rumah tangga yang rutin dan sangat dekat dengan repeat order.",
  ...
  },
  {
    ...
    description: "Panduan membayar internet pascabayar secara online melalui NuansaPulsa untuk kebutuhan pribadi, keluarga, dan bisnis PPOB.",
    ...
    hero: "Kategori internet pascabayar membantu NuansaPulsa menjangkau kebutuhan digital rumah tangga yang terus tumbuh.",
    ...
    sections: [
      {
        ...
        body: [
          ...
          "Kategori ini juga memperkuat citra NuansaPulsa sebagai platform kebutuhan rumah tangga digital, bukan hanya top up harian.",
        ],
      },
      {
  ...
  },
  {
    ...
    description: "Panduan membayar tagihan HP pascabayar melalui NuansaPulsa untuk pelanggan pribadi, agen, dan website PPOB.",
  ...
  },
  {
    ...
    description: "Panduan membeli voucher TV digital dan membayar layanan TV berlangganan melalui NuansaPulsa untuk pelanggan rumah tangga dan agen PPOB.",
    ...
    hero: "Kategori TV membuat layanan rumah tangga di NuansaPulsa terasa lebih lengkap dan lebih relevan untuk repeat order.",
  ...
  },
  {
    ...
    description: "Panduan memperpanjang masa aktif nomor HP melalui NuansaPulsa agar nomor tetap aktif tanpa harus membeli produk yang tidak diperlukan.",
  ...
  },
  {
    ...
    description: "Panduan aktivasi perdana dan top up awal nomor baru lewat NuansaPulsa untuk pengguna baru, agen, dan penjual starter pack.",
  ...
  },
  {
    ...
    description: "Panduan memulai usaha jualan pulsa dari rumah dengan produk awal yang tepat, langkah sederhana, dan arah tumbuh bersama NuansaPulsa.",
  ...
  {
    slug: "cara-menjadi-agen-pulsa-di-nuansapulsa",
    title: "Cara Menjadi Agen Pulsa di NuansaPulsa",
    description: "Panduan menjadi agen NuansaPulsa dari pendaftaran, pilihan produk awal, sampai cara membangun layanan yang rapi dan repeat order.",
    ...
    category: "Bisnis Agen",
    readTime: "7 menit",
    keywords: ["cara menjadi agen pulsa", "daftar agen pulsa", "agen nuansapulsa", "reseller produk digital"],
    ...
    sections: [
      {
        ...
        body: [
          ...
          "NuansaPulsa memberi fondasi yang baik karena kategori produk utama sudah tersedia dalam satu platform.",
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          "Dengan jalur seperti ini, agen tidak perlu pindah platform saat bisnis mulai tumbuh. NuansaPulsa tetap bisa dipakai dari tahap awal sampai tahap usaha yang lebih serius.",
        ],
      },
    ],
    faqs: [
  ...
  {
    slug: "cara-menjadi-member-h2h-nuansapulsa",
    title: "Cara Menjadi Member H2H NuansaPulsa untuk Bisnis yang Lebih Besar",
    description: "Panduan menjadi member H2H NuansaPulsa untuk website, aplikasi, atau panel reseller yang ingin transaksi lebih otomatis dan rapi.",
    ...
    category: "H2H",
    readTime: "8 menit",
    keywords: ["member h2h", "host to host pulsa", "api pulsa", "nuansapulsa h2h"],
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "NuansaPulsa memberi jalur ini untuk member yang ingin bergerak dari layanan manual ke sistem yang lebih otomatis tanpa harus mengganti basis produk.",
        ],
      },
    ],
    faqs: [
  ...
  },
  {
    ...
    description: "Panduan membuat website jualan pulsa dengan halaman produk yang jelas, struktur layanan yang rapi, dan arah tumbuh ke H2H NuansaPulsa.",
  ...
  {
    slug: "keuntungan-berlangganan-dan-bertumbuh-bersama-nuansapulsa",
    title: "Keuntungan Berlangganan dan Bertumbuh Bersama NuansaPulsa",
    description: "Keuntungan memakai NuansaPulsa untuk agen, reseller, dan bisnis yang ingin tumbuh dari transaksi harian ke website atau H2H.",
    ...
    category: "Bisnis Agen",
    readTime: "6 menit",
    keywords: ["keuntungan nuansapulsa", "platform jualan pulsa", "reseller produk digital", "agen nuansapulsa"],
    hero: "NuansaPulsa relevan bukan hanya untuk transaksi harian, tetapi juga untuk pertumbuhan bisnis jangka panjang.",
    ...
    sections: [
      {
        ...
        body: [
          "NuansaPulsa tidak berhenti di satu kategori. Pulsa, paket data, e-wallet, token listrik, game, dan PPOB saling mendukung untuk membentuk layanan yang lebih lengkap.",
      ...
      },
      {
        ...
        body: [
          "Calon member biasanya ingin tahu apakah sebuah platform hanya cocok untuk transaksi kecil atau juga bisa dipakai untuk bertumbuh. NuansaPulsa memberi jawaban lewat jalur yang jelas dari transaksi harian sampai integrasi yang lebih serius.",
    ...
    faqs: [
      { question: "Apa keuntungan utama NuansaPulsa untuk agen?", answer: "Agen bisa menjual pulsa, paket data, e-wallet, token listrik, game, dan layanan rumah tangga tanpa pindah-pindah platform saat usaha mulai tumbuh." },
      { question: "Apakah NuansaPulsa cocok untuk pemula dan bisnis bertumbuh?", answer: "Ya. Pemula bisa mulai dari pulsa, kuota, dan e-wallet, sementara bisnis yang lebih siap bisa naik ke website jualan dan H2H." },
    ],
  },
  {
  ...
  },
  {
    ...
    title: "Cara Beli Paket Telepon Semua Operator di NuansaPulsa",
    description: "Panduan membeli paket telepon semua operator di NuansaPulsa untuk pelanggan harian dan member yang ingin menambah layanan pelengkap.",
    ...
    sections: [
      {
        ...
        body: [
          ...
          "Karena itu, kategori paket telepon tetap penting untuk membuat layanan NuansaPulsa terasa lebih lengkap.",
        ],
      },
      {
        heading: "Cara membeli paket telepon di NuansaPulsa",
        body: [
  ...
  },
  {
    ...
    title: "Cara Beli Pulsa Data dan Kombinasi Pulsa Kuota di NuansaPulsa",
    description: "Panduan membeli pulsa data dan produk kombinasi pulsa-kuota di NuansaPulsa untuk pelanggan yang butuh pilihan lebih fleksibel.",
    ...
    hero: "Pulsa data membantu NuansaPulsa menjangkau kebutuhan operator yang tidak selalu pas jika hanya dibagi antara pulsa reguler dan paket data biasa.",
    ...
    sections: [
      {
        heading: "Apa itu pulsa data di NuansaPulsa",
        body: [
      ...
      },
      {
        ...
        body: [
          "Pulsa data membantu NuansaPulsa terlihat lebih lengkap karena mampu menutup celah antara pulsa reguler dan kuota biasa.",
  ...
  },
  {
    ...
    description: "Panduan membayar PGN online melalui NuansaPulsa untuk pelanggan rumah tangga dan agen yang ingin layanan energinya lebih lengkap.",
    excerpt: "PGN adalah kategori yang membuat layanan rumah tangga di NuansaPulsa terasa lebih lengkap bersama listrik, PDAM, dan internet pascabayar.",
    category: "PGN",
    readTime: "5 menit",
    keywords: ["bayar pgn online", "tagihan gas online", "pgn rumah tangga", "ppob pgn"],
    hero: "PGN memperluas layanan NuansaPulsa ke kebutuhan energi rumah tangga yang lebih lengkap dan lebih bernilai untuk pelanggan bulanan.",
    ...
    sections: [
      {
        ...
        body: [
          ...
          "Kategori seperti ini memberi kesan bahwa NuansaPulsa bukan hanya platform top up, tetapi juga pusat pembayaran digital keluarga.",
        ],
      },
      {
        heading: "Cara bayar PGN di NuansaPulsa",
        body: [
      ...
      },
      {
        ...
        body: [
          ...
          "Inilah salah satu masa depan NuansaPulsa: tumbuh dari kebutuhan harian seperti pulsa dan kuota ke kebutuhan rumah tangga yang lebih menyeluruh.",
        ],
      },
    ],
    faqs: [
  ...
  },
  {
    ...
    title: "Cara Top Up Saldo Member dengan QRIS dan Bank di NuansaPulsa",
    description: "Panduan top up saldo member NuansaPulsa lewat QRIS dan bank agar transaksi harian dan operasional agen tetap lancar.",
    ...
    category: "Deposit",
    readTime: "6 menit",
    keywords: ["top up saldo member", "deposit qris", "saldo nuansapulsa", "isi saldo agen"],
    ...
    sections: [
      {
        ...
        body: [
          ...
          "Karena itu, top up saldo bukan sekadar fitur tambahan, tetapi bagian inti dari operasional bisnis di NuansaPulsa.",
        ],
      },
      {
        heading: "Cara top up saldo di NuansaPulsa",
        body: [
  ...
  {
    slug: "perbedaan-member-retail-agen-dan-h2h-di-nuansapulsa",
    title: "Perbedaan Member Retail, Agen, dan H2H di NuansaPulsa",
    description: "Panduan memahami beda retail, agen, dan H2H di NuansaPulsa agar calon member bisa memilih model usaha yang paling sesuai.",
    ...
    readTime: "7 menit",
    keywords: ["member retail", "agen pulsa", "h2h nuansapulsa", "perbedaan retail agen h2h"],
    hero: "NuansaPulsa bisa dipakai dari level transaksi harian sampai integrasi bisnis. Bedanya ada pada cara kerja, skala, dan kebutuhan operasionalnya.",
    products: ["Pulsa Telkomsel", "DANA", "Token Listrik Promo", "BPJS Kesehatan", "API H2H"],
    ctaLabel: "Lihat Jalur Retail, Agen, dan H2H",
    ctaHref: "/artikel/cara-bertumbuh-dari-retail-ke-agen-dan-h2h-bersama-nuansapulsa",
    publishedAt,
    updatedAt,
    sections: [
      {
      ...
      },
      {
        ...
        body: [
          ...
          "Dengan memahami perbedaan tiga model ini, calon member bisa merancang masa depan usahanya di NuansaPulsa dengan lebih realistis.",
        ],
      },
    ],
    faqs: [
  ...
  {
    slug: "cara-bertumbuh-dari-retail-ke-agen-dan-h2h-bersama-nuansapulsa",
    title: "Cara Bertumbuh dari Retail ke Agen dan H2H Bersama NuansaPulsa",
    description: "Panduan bertahap untuk tumbuh dari retail ke agen lalu ke H2H di NuansaPulsa tanpa kehilangan kendali operasional.",
    ...
    category: "Bisnis Agen",
    readTime: "8 menit",
    keywords: ["naik dari retail ke agen", "bertumbuh ke h2h", "masa depan usaha pulsa", "nuansapulsa bisnis"],
    hero: "NuansaPulsa paling bernilai ketika dipakai sebagai jalur pertumbuhan usaha, bukan hanya sebagai tempat transaksi harian.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Masa depan usaha bersama NuansaPulsa adalah kemampuan untuk naik tahap tanpa harus mengganti fondasi produk yang sudah Anda bangun sejak awal.",
        ],
      },
    ],
    faqs: [
  ...
  {
    slug: "produk-nuansapulsa-yang-paling-cocok-untuk-calon-member",
    title: "Produk NuansaPulsa yang Paling Cocok untuk Calon Member",
    description: "Panduan memilih produk NuansaPulsa untuk calon member, dari pulsa, paket data, e-wallet, game, listrik, sampai PPOB rumah tangga.",
    ...
    category: "Panduan Member",
    readTime: "8 menit",
    keywords: ["produk nuansapulsa", "calon member nuansapulsa", "produk paling laris", "usaha produk digital"],
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Dengan jalur bertumbuh seperti ini, NuansaPulsa tidak hanya membantu transaksi harian, tetapi juga perkembangan usaha jangka panjang.",
        ],
      },
    ],
    faqs: [
  ...
  },
  {
    ...
    description: "Panduan membangun warung pulsa dan PPOB dengan produk yang tepat, layanan rumah tangga yang lengkap, dan arah tumbuh bersama NuansaPulsa.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Dari titik ini, NuansaPulsa bisa dipakai bukan hanya untuk melayani warung harian, tetapi juga untuk menyiapkan langkah usaha yang lebih besar.",
        ],
      },
    ],
    faqs: [
  ...
  },
  {
    ...
    description: "Panduan menyusun katalog produk digital agar pembeli cepat paham, mudah memilih, dan lebih nyaman bertransaksi di layanan NuansaPulsa Anda.",
  ...
  },
  {
    ...
    description: "Panduan mengelola pelanggan rutin untuk token listrik, BPJS, PDAM, dan tagihan rumah tangga agar repeat order lebih stabil di NuansaPulsa.",
  ...
  {
    slug: "cara-membangun-panel-reseller-dengan-h2h-nuansapulsa",
    title: "Cara Membangun Panel Reseller dengan H2H NuansaPulsa",
    description: "Panduan membangun panel reseller dengan H2H NuansaPulsa untuk bisnis yang ingin menerima order otomatis dan menata operasional lebih rapi.",
    ...
    category: "H2H",
    readTime: "8 menit",
    keywords: ["panel reseller", "h2h nuansapulsa", "api panel pulsa", "reseller otomatis"],
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "NuansaPulsa cocok dipakai di tahap ini karena memberi jalur dari member biasa ke integrasi yang lebih serius tanpa mengganti fondasi produk.",
        ],
      },
    ],
    faqs: [
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "NuansaPulsa cocok untuk pola seperti ini karena kategori rumah tangganya bisa melengkapi top up harian dalam satu layanan.",
        ],
      },
    ],
    faqs: [
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "NuansaPulsa cocok untuk tahap ini karena bisa dipakai dari alur chat manual sampai ke jalur usaha yang lebih besar.",
        ],
      },
    ],
    faqs: [
  ...
  },
  {
    ...
    description: "Panduan memanfaatkan promo operator sambil tetap menjaga katalog produk rapi, mudah dipahami, dan nyaman dipakai pelanggan NuansaPulsa.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "NuansaPulsa mendukung pola ini karena member bisa memulai dari usaha kecil lalu menyesuaikan modal, produk, dan ritme transaksi secara bertahap.",
        ],
      },
    ],
    faqs: [
...
const productQuickLinkMap: Record<string, QuickLink> = {
  ...
  Agen: { label: "Panduan Menjadi Agen", href: "/artikel/cara-menjadi-agen-pulsa-di-nuansapulsa" },
  H2H: { label: "Panduan Member H2H", href: "/artikel/cara-menjadi-member-h2h-nuansapulsa" },
...
const relatedArticleMap: Record<string, string[]> = {
  ...
  "cara-top-up-ewallet-dana-ovo-gopay-linkaja": [
    ...
    "produk-nuansapulsa-yang-paling-cocok-untuk-calon-member",
  ],
  "cara-top-up-game-mobile-legends-free-fire-pubg": [
    "cara-top-up-ewallet-dana-ovo-gopay-linkaja",
    "cara-beli-paket-data-harian-dan-bulanan",
  ...
  "cara-bayar-bpjs-kesehatan-online": [
    "cara-bayar-tagihan-listrik-online",
    "cara-bayar-pdam-online",
    "cara-menjadi-agen-pulsa-di-nuansapulsa",
  ],
  "cara-bayar-pdam-online": [
    "cara-bayar-tagihan-listrik-online",
    "cara-bayar-bpjs-kesehatan-online",
  ...
  "cara-menjadi-member-h2h-nuansapulsa": [
    "perbedaan-member-retail-agen-dan-h2h-di-nuansapulsa",
    "cara-bertumbuh-dari-retail-ke-agen-dan-h2h-bersama-nuansapulsa",
    "cara-membuat-website-jualan-pulsa-sendiri",
  ],
  "cara-membuat-website-jualan-pulsa-sendiri": [
    "cara-menjadi-agen-pulsa-di-nuansapulsa",
    "cara-menjadi-member-h2h-nuansapulsa",
    "cara-membangun-panel-reseller-dengan-h2h-nuansapulsa",
  ],
  "keuntungan-berlangganan-dan-bertumbuh-bersama-nuansapulsa": [
    "produk-nuansapulsa-yang-paling-cocok-untuk-calon-member",
    "cara-bertumbuh-dari-retail-ke-agen-dan-h2h-bersama-nuansapulsa",
