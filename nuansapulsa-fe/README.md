# Dokumentasi Jaringan Retail NuansaPulsa

README ini menjelaskan modul jaringan retail pada aplikasi NuansaPulsa, mulai dari role, struktur downline, komisi, withdraw, endpoint, sampai tabel database yang dipakai.
...
- `nuansapulsa-fe/components/user/RetailDownlineManager.tsx`
- `nuansapulsa-fe/components/user/RetailCommissionClient.tsx`
- `nuansapulsa-fe/components/user/RetailWithdrawClient.tsx`
- `nuansapulsa-fe/components/dashboard/RetailWithdrawRequestsPage.tsx`
- `nuansapulsa-fe/lib/memberRoles.ts`
