        ...
        <header className="overflow-hidden rounded-[28px] border border-emerald-100 bg-white shadow-[0_20px_50px_rgba(15,23,42,0.07)]">
          <div className="bg-[linear-gradient(135deg,#053a2f_0%,#087a50_62%,#50cf3e_100%)] px-5 py-6 text-white sm:px-7">
            <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
              <div><p className="text-[11px] font-black uppercase tracking-[0.18em] text-lime-100">Pengawasan Akun</p><h1 className="mt-2 text-3xl font-black">Aktivitas Akun</h1><p className="mt-2 text-sm font-semibold text-emerald-50/90">Riwayat transaksi dan pergerakan saldo pengguna NuansaPulsa.</p></div>
