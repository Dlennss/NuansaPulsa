...
function appBaseURL() {
  return (
    ...
    process.env.APP_URL ||
    "https://domain-nuansapulsa-kamu.com"
  ).replace(/\/$/, "");
}
...
const commandRows = [
  ...
  },
  {
    ...
    catatan: "Refid wajib unik dari sistem NuansaPulsa.",
  },
  {
    command: "INQ",
  ...
  const steps = [
    {
      ...
      desc: "Daftarkan IP publik server NuansaPulsa di Pulsa24Jam. Tanpa ini, transaksi H2H akan ditolak.",
      icon: ShieldCheck,
    },
    {
      title: "2. Webhook Callback",
      desc: "Pasang URL callback NuansaPulsa agar status pending, sukses, gagal, SN, dan keterangan final masuk otomatis.",
      icon: Webhook,
    },
    {
      title: "3. API Key",
