      ...
      <section className="rounded-2xl border border-cyan-400/15 bg-linear-to-br from-cyan-500/10 via-slate-950/50 to-slate-950/70 p-5 shadow-[0_16px_40px_-26px_rgba(0,0,0,0.8)]">
        <div className="space-y-2">
          ...
          <div className="text-sm leading-6 text-white/70">
            ...
            NuansaPulsa dengan benar: daftarkan IP, pasang webhook callback, simpan API key, siapkan PIN, lalu kirim transaksi.
          </div>
        </div>
        ...
        <div className="mt-4 rounded-2xl border border-white/10 bg-black/25 p-4">
          ...
          <div className="mt-4 rounded-2xl border border-white/10 bg-black/20 p-4">
            ...
            <div className="mt-2 text-sm leading-6 text-white/70">
              Semua request dikirim ke <span className="font-mono text-white">POST https://api.nuansapulsa.net/v1/trx</span> dengan
          ...
          <div className="mt-4 rounded-2xl border border-white/10 bg-black/20 p-4">
            ...
            <div className="mt-4 grid gap-4 xl:grid-cols-2">
              <div>
                ...
                <pre className="overflow-x-auto rounded-xl border border-white/10 bg-slate-950/60 p-4 text-xs leading-6 text-white/80">{`curl -X POST &apos;https://api.nuansapulsa.net/v1/trx&apos; \
