  ...
  return (
    <main className="min-h-screen bg-[#fff6f4] px-4 pb-24 pt-5">
      <div className="mx-auto w-full max-w-md space-y-4">
        <Link href={backendToken ? "/user/transaksi" : "/user"} className="inline-flex items-center gap-2 text-sm font-medium text-[#d70717] hover:text-[#b80616]">
        ...
        <section className="rounded-3xl bg-white p-5 shadow-[0_8px_22px_rgba(15,23,42,0.13)]">
          {error ? (
            <div className="text-center py-8">
              ...
              {!backendToken ? (
                <Link href="/?focus=invoice-checker" className="mt-4 inline-flex items-center justify-center rounded-xl bg-red-600 px-4 py-2 text-sm font-semibold text-white">
            ...
            <>
              ...
              <div className="mt-5 rounded-3xl bg-[#fff6f4] p-4">
                <p className="text-xs font-semibold tracking-wide text-[#d70717] uppercase">Total Pembayaran</p>
