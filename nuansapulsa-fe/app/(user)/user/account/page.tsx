...
export default async function UserAccountPage() {
  ...
  const username = displayEmail !== "-" ? `@${displayEmail.split("@")[0]}` : "@nuansapulsa";
  ...
  const settingItems = [
      ...
      : []),
    {
      ...
      desc: "Ketentuan penggunaan NuansaPulsa",
      icon: FileText,
    },
  ];
  ...
  return (
    <main className="min-h-screen bg-[#f3f7f5] pb-24">
      ...
      <div className="mx-auto -mt-4 w-full max-w-md space-y-3.5 px-4">
        ...
        <p className="pt-2 text-center text-[10px] font-semibold text-slate-400">NuansaPulsa versi 1.0.0</p>
      </div>
