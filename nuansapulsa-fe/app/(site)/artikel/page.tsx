...
export const metadata: Metadata = {
  ...
  title: "Artikel NuansaPulsa",
  description:
    "Panduan lengkap tentang produk NuansaPulsa, keuntungan menjadi member, layanan H2H, website jualan sendiri, dan kebutuhan transaksi digital harian.",
  alternates: {
      ...
      <section className="relative space-y-4 px-4 pb-6 pt-4">
        ...
        <div className="overflow-hidden rounded-md border border-sky-100 bg-linear-to-br from-white via-sky-50/70 to-cyan-50/80 p-4 shadow-[0_18px_40px_rgba(15,111,203,0.10)]">
          ...
          <h1 className="mt-4 text-2xl font-black leading-tight tracking-tight text-slate-950">
            Panduan lengkap tentang produk dan peluang usaha di NuansaPulsa
          </h1>
          <p className="mt-3 text-sm leading-7 text-slate-600">
            Halaman ini berisi panduan untuk calon pelanggan, calon member, agen, dan pemilik bisnis yang ingin memahami produk NuansaPulsa
            dengan lebih jelas.
          </p>
        </div>
