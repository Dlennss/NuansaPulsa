...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!article) {
    return {
      title: "Artikel Tidak Ditemukan | NuansaPulsa",
    };
  }

  return {
    metadataBase: new URL(CANONICAL_SITE_URL),
    title: `${article.title} | NuansaPulsa`,
...
export default async function ArtikelDetailPage({ params }: Props) {
  ...
  const ctaDescription =
    article.category === "Bisnis Agen"
      ? "Setelah memahami arahnya, lanjutkan ke halaman NuansaPulsa yang paling membantu pertumbuhan usaha dan layanan member Anda."
      : article.category === "Panduan Member"
        ...
        : article.category === "H2H"
          ...
          : article.category === "Deposit"
            ...
            : "Jika Anda sudah memahami produknya, lanjutkan ke halaman layanan NuansaPulsa yang paling relevan untuk kebutuhan Anda.";
