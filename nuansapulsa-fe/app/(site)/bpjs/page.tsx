...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: "Cek dan bayar BPJS Kesehatan dan BPJS Ketenagakerjaan di NuansaPulsa dengan alur yang ringkas.",
  path: "/bpjs",
  keywords: ["bpjs kesehatan", "bpjs ketenagakerjaan", "bayar bpjs", "nuansapulsa"],
});
