...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (slug !== "kesehatan" && slug !== "ketenagakerjaan") {
    return buildPageMetadata({
      title: "BPJS | NuansaPulsa",
      description: "Cek dan bayar BPJS di NuansaPulsa.",
      path: "/bpjs",
    });
  }
  ...
  return buildPageMetadata({
    title: `${title} | NuansaPulsa`,
    description: `Cek dan bayar ${title} di NuansaPulsa dengan alur yang ringkas.`,
    path: `/bpjs/${slug}`,
    keywords: [title.toLowerCase(), "bayar bpjs", "nuansapulsa"],
  });
}
