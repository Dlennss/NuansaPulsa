...
export const metadata: Metadata = buildPageMetadata({
  title: "Produk Listrik PLN | NuansaPulsa",
  description: "Pilih token listrik atau pembayaran tagihan listrik PLN di NuansaPulsa.",
  path: "/listrik",
  keywords: ["token listrik", "tagihan listrik", "pln", "nuansapulsa"],
});
  ...
  const cards = [
    {
      ...
      href: "/listrik/token",
      icon: Zap,
      accent: "from-amber-300 via-red-500 to-[#d70717]",
    },
    {
      key: "tagihan",
      ...
      icon: FileText,
      accent: "from-yellow-300 via-red-500 to-[#d70717]",
    },
  ];
    ...
    <main className="min-h-screen bg-[#fff6f4]">
      ...
      <div className="space-y-4 px-4 pt-4 pb-28">
        {!listrikCategory ? (
          ...
          <>
            <section className="relative overflow-hidden rounded-[30px] bg-[#d70717] p-4 text-white shadow-[0_22px_48px_rgba(151,14,32,0.26)]">
              <div className="relative flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <p className="text-[10px] font-black uppercase tracking-[0.18em] text-amber-200">NuansaPulsa PLN</p>
            ...
            <section className="grid gap-3">
              ...
              return (
                <Link
                  key={card.key}
                  href={card.href}
                  className="group relative overflow-hidden rounded-[28px] border border-white bg-white p-3 shadow-[0_16px_36px_rgba(151,14,32,0.10)] ring-1 ring-rose-950/5 transition duration-300 hover:-translate-y-1 hover:shadow-[0_20px_42px_rgba(151,14,32,0.15)]"
                >
                  ...
                  <div className="relative flex items-center gap-3">
                    <span className={`grid h-13 w-13 shrink-0 place-items-center rounded-[20px] bg-linear-to-br ${card.accent} text-white shadow-[0_12px_24px_rgba(151,14,32,0.16)]`}>
                    ...
                    <span className="grid h-9 w-9 shrink-0 place-items-center rounded-full bg-amber-100 text-[#d70717] transition group-hover:translate-x-0.5 group-hover:bg-amber-300">
