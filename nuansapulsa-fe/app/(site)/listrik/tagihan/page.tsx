...
export const metadata: Metadata = buildPageMetadata({
  title: "Tagihan Listrik PLN | NuansaPulsa",
  description: "Bayar tagihan listrik PLN di NuansaPulsa dengan alur yang ringkas untuk pelanggan rumah tangga dan agen.",
  path: "/listrik/tagihan",
  keywords: ["tagihan listrik", "bayar listrik", "pln pascabayar", "nuansapulsa listrik"],
});
