...
export const metadata: Metadata = buildPageMetadata({
  title: "Token Listrik PLN | NuansaPulsa",
  description: "Beli token listrik PLN di NuansaPulsa dengan pilihan nominal dan grup produk yang lebih jelas.",
  path: "/listrik/token",
  keywords: ["token listrik", "token pln", "beli token listrik", "nuansapulsa listrik"],
