...
export const metadata: Metadata = buildPageMetadata({
  title: "Paket Data Semua Operator | NuansaPulsa",
  description: "Beli paket data harian, mingguan, dan bulanan semua operator di NuansaPulsa dengan pilihan grup produk yang lebih jelas.",
  path: "/paket-data",
  keywords: ["paket data", "kuota internet", "paket data telkomsel", "paket data indosat", "nuansapulsa"],
});
