...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: "Pilih produk aktivasi perdana semua operator di NuansaPulsa dengan pilihan yang ringkas dan jelas.",
  path: "/aktivasi-perdana",
  keywords: ["aktivasi perdana", "kartu perdana", "aktivasi kartu operator", "nuansapulsa"],
});
