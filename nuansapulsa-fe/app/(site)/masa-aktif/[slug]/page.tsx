...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Masa Aktif Semua Operator | NuansaPulsa",
      description: "Perpanjang masa aktif nomor Anda di NuansaPulsa.",
      path: "/masa-aktif",
    });
  }
  ...
  return buildPageMetadata({
    title: `Perpanjang Masa Aktif ${brandTitle} | NuansaPulsa`,
    description: lowestPrice
      ? `Perpanjang masa aktif ${brandTitle} di NuansaPulsa. Produk aktif tersedia mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Perpanjang masa aktif ${brandTitle} di NuansaPulsa dengan pilihan produk yang jelas.`,
    path: `/masa-aktif/${slug}`,
    keywords: [`masa aktif ${brand.nama.toLowerCase()}`, `perpanjang masa aktif ${brand.nama.toLowerCase()}`, "nuansapulsa"],
...
export default async function MasaAktifBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Perpanjang Masa Aktif ${brandTitle} | NuansaPulsa`,
    description: `Perpanjang masa aktif ${brandTitle} di NuansaPulsa dengan pilihan produk yang jelas.`,
    path: `/masa-aktif/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah masa aktif ${brandTitle} di NuansaPulsa tersedia dalam beberapa pilihan?`,
      answer: `Ya. NuansaPulsa menampilkan produk masa aktif ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara memperpanjang masa aktif ${brandTitle} di NuansaPulsa?`,
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini bisa dipakai pembeli umum maupun member NuansaPulsa untuk kebutuhan pribadi dan penjualan ulang.`,
    },
  ]);
