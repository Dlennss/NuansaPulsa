...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: "Perpanjang masa aktif nomor Anda di NuansaPulsa dengan pilihan operator dan nominal yang jelas.",
  path: "/masa-aktif",
  keywords: ["masa aktif", "perpanjang masa aktif", "masa aktif operator", "nuansapulsa"],
});
