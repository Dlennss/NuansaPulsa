...
export const metadata: Metadata = buildPageMetadata({
  title: "Pulsa dan Paket Data | NuansaPulsa",
  description: "Jelajahi pulsa dan paket data semua operator di NuansaPulsa dalam satu halaman yang ringkas.",
  path: "/pulsa-data",
  keywords: ["pulsa dan paket data", "pulsa online", "paket data operator", "nuansapulsa"],
});
