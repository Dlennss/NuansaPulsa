...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!phoneCategory) {
    return buildPageMetadata({
      title: "Paket Telepon Semua Operator | NuansaPulsa",
      description: "Pilih paket telepon operator di NuansaPulsa.",
      path: "/paket-telepon",
    });
  }
  ...
  return buildPageMetadata({
    title: `Paket Telepon ${brandTitle} | NuansaPulsa`,
    description: lowestPrice
      ? `Pilih paket telepon ${brandTitle} di NuansaPulsa. Produk aktif tersedia mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Pilih paket telepon ${brandTitle} di NuansaPulsa dengan pilihan produk yang jelas.`,
    path: `/paket-telepon/${slug}`,
    keywords: [`paket telepon ${brand.nama.toLowerCase()}`, `nelpon ${brand.nama.toLowerCase()}`, "nuansapulsa"],
...
export default async function GuestPaketTeleponBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Paket Telepon ${brandTitle} | NuansaPulsa`,
    description: `Pilih paket telepon ${brandTitle} di NuansaPulsa dengan pilihan produk yang jelas.`,
    path: `/paket-telepon/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah paket telepon ${brandTitle} di NuansaPulsa tersedia dalam banyak pilihan?`,
      answer: `Ya. NuansaPulsa menampilkan paket telepon ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara membeli paket telepon ${brandTitle} di NuansaPulsa?`,
