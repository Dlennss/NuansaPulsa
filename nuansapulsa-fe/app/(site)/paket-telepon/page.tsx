...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: "Pilih paket telepon semua operator di NuansaPulsa dengan pilihan produk yang jelas dan ringkas.",
  path: "/paket-telepon",
  keywords: ["paket telepon", "nelpon semua operator", "paket telepon operator", "nuansapulsa"],
});
