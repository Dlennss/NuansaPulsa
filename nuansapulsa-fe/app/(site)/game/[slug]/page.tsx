...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      ...
      description: "Top up game online favorit Anda di NuansaPulsa.",
      path: "/game",
    });
  }
  ...
  return buildPageMetadata({
    title: `Top Up ${brandTitle} Murah | NuansaPulsa`,
    description: lowestPrice
      ? `Top up ${brandTitle} di NuansaPulsa dengan pilihan nominal aktif. Harga mulai Rp ${lowestPrice.toLocaleString("id-ID")} dan transaksi cepat.`
      : `Top up ${brandTitle} di NuansaPulsa dengan pilihan nominal yang jelas dan proses transaksi cepat.`,
    path: `/game/${slug}`,
    keywords: [`top up ${brand.nama.toLowerCase()}`, `${brand.nama.toLowerCase()} murah`, "voucher game", "nuansapulsa"],
...
export default async function GameBrandPage({ params, searchParams }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Top Up ${brandTitle} Murah | NuansaPulsa`,
    description: `Top up ${brandTitle} di NuansaPulsa dengan pilihan nominal yang jelas dan proses transaksi cepat.`,
    path: `/game/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah top up ${brandTitle} di NuansaPulsa tersedia dalam banyak pilihan nominal?`,
      answer: `Ya. NuansaPulsa menampilkan produk ${brandTitle} yang aktif agar pembeli bisa memilih nominal yang sesuai kebutuhan.`,
    },
    {
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini bisa dipakai pembeli umum maupun member NuansaPulsa untuk transaksi pribadi dan penjualan ulang.`,
    },
  ]);
