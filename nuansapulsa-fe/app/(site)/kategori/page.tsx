...
export const metadata: Metadata = buildPageMetadata({
  title: "Semua Kategori Produk | NuansaPulsa",
  description: "Lihat semua kategori produk NuansaPulsa, mulai dari pulsa, paket data, e-wallet, game, sampai tagihan.",
  path: "/kategori",
  keywords: ["kategori produk nuansapulsa", "semua produk", "nuansapulsa"],
});
