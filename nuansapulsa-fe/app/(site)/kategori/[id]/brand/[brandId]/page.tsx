...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return buildPageMetadata({
    title: `${brand} | ${categoryName} NuansaPulsa`,
    description: `Lihat produk ${brand} pada kategori ${categoryName} di NuansaPulsa.`,
    path: `/kategori/${id}/brand/${brandId}`,
    keywords: [String(brand).toLowerCase(), String(categoryName).toLowerCase(), "nuansapulsa"],
...
export default async function GuestBrandProductsPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `${brand} | ${categoryName || "Produk"} NuansaPulsa`,
    description: `Lihat produk ${brand} pada kategori ${categoryName || "produk"} di NuansaPulsa.`,
    path: `/kategori/${id}/brand/${brandId}`,
