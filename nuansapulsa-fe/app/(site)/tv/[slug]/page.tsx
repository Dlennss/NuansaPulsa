...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "TV Berlangganan | NuansaPulsa",
      description: "Beli paket atau bayar layanan TV berlangganan di NuansaPulsa.",
      path: "/tv",
    });
  }

  return buildPageMetadata({
    title: `${brand.nama} | TV Berlangganan NuansaPulsa`,
    description: `Beli paket atau bayar layanan ${brand.nama} di NuansaPulsa dengan proses yang ringkas.`,
    path: `/tv/${slug}`,
    keywords: [`${brand.nama.toLowerCase()}`, `bayar ${brand.nama.toLowerCase()}`, "tv berlangganan", "nuansapulsa"],
