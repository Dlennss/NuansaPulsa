...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: "Beli paket atau bayar layanan TV berlangganan di NuansaPulsa dengan pilihan brand yang jelas.",
  path: "/tv",
  keywords: ["tv berlangganan", "bayar tv online", "voucher tv", "nuansapulsa"],
});
