...
const services = [
  ...
  },
  {
    ...
    description: "NuansaPulsa mendukung pelanggan retail sampai kebutuhan partner bisnis dan integrasi H2H.",
    href: "/docs",
  },
];
...
const commitments = [
  ...
  },
  {
    ...
    description: "NuansaPulsa diarahkan sebagai partner transaksi digital yang siap dipakai untuk kebutuhan pribadi, warung, agen, dan reseller.",
    icon: ShieldCheck,
  },
  {
...
const pageTitle = "Tentang NuansaPulsa | Layanan Produk Digital untuk Retail, Agen, dan H2H";
const pageDescription =
  "Kenali NuansaPulsa sebagai layanan produk digital untuk pulsa, paket data, e-wallet, token listrik, PPOB, agen, dan kebutuhan H2H.";
        ...
        <div className="overflow-hidden rounded-[28px] border border-white/70 bg-linear-to-br from-[#0f6fcb] via-[#1576d0] to-[#2f92df] px-5 py-6 text-white shadow-[0_24px_60px_rgba(15,111,203,0.22)]">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div className="max-w-[19rem]">
              <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-white/72">Tentang NuansaPulsa</p>
              ...
              <p className="mt-4 text-sm leading-6 text-white/90 text-justify">
                NuansaPulsa melayani kebutuhan pulsa, paket data, e-wallet, token listrik, top up game, dan PPOB untuk
        ...
        <div className="grid gap-4">
          <div className="rounded-[28px] border border-sky-100 bg-white p-5 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
            ...
            <h2 className="mt-2 text-xl font-black tracking-tight text-slate-950">
              Produk utama NuansaPulsa disusun untuk kebutuhan harian sampai kebutuhan usaha
            </h2>
            <p className="mt-3 text-sm leading-6 text-slate-600 text-justify">
              Kami membangun NuansaPulsa agar pelanggan cepat menemukan layanan yang dicari, dan pada saat yang sama
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h2 className="mt-1 text-xl font-black tracking-tight text-slate-950">
                Pelajari NuansaPulsa lebih dalam lewat artikel dan panduan member
              </h2>
            </div>
          </div>
