...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: "Cek dan bayar tagihan internet pascabayar di NuansaPulsa dengan pilihan provider yang jelas.",
  path: "/internet-pascabayar",
  keywords: ["internet pascabayar", "bayar internet online", "tagihan internet", "nuansapulsa"],
});
