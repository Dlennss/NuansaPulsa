...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Top Up E-Wallet | NuansaPulsa",
      description: "Top up e-wallet favorit Anda di NuansaPulsa.",
      path: "/ewallet",
    });
  }
  ...
  return buildPageMetadata({
    title: `Top Up ${brandTitle} Online | NuansaPulsa`,
    description: lowestPrice
      ? `Top up ${brandTitle} online di NuansaPulsa dengan nominal tetap dan bebas nominal. Harga mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Top up ${brandTitle} di NuansaPulsa dengan pilihan nominal tetap dan bebas nominal yang lebih jelas.`,
    path: `/ewallet/${slug}`,
    keywords: [`top up ${brand.nama.toLowerCase()}`, `${brand.nama.toLowerCase()} nuansapulsa`, "ewallet"],
...
export default async function EwalletBrandPage({ params, searchParams }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Top Up ${brandTitle} Online | NuansaPulsa`,
    description: `Top up ${brandTitle} di NuansaPulsa dengan pilihan nominal tetap dan bebas nominal yang lebih jelas.`,
    path: `/ewallet/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah top up ${brandTitle} di NuansaPulsa bisa pilih nominal tetap dan bebas nominal?`,
      answer: `Ya. NuansaPulsa menampilkan produk ${brandTitle} yang aktif, termasuk nominal tetap dan varian bebas nominal bila tersedia.`,
    },
    {
      question: `Bagaimana cara top up ${brandTitle} di NuansaPulsa?`,
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini dipakai untuk kebutuhan top up pribadi maupun penjualan ulang oleh member NuansaPulsa.`,
    },
  ]);
