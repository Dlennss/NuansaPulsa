...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: "Top up DANA, OVO, GoPay, LinkAja, dan ShopeePay di NuansaPulsa dengan nominal tetap maupun bebas nominal.",
  path: "/ewallet",
  keywords: ["top up dana", "top up ovo", "top up gopay", "top up linkaja", "ewallet nuansapulsa"],
});
