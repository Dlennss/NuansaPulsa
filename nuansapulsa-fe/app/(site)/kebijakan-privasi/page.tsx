...
const pageTitle = "Syarat & Ketentuan NuansaPulsa | Layanan Produk Digital";
const pageDescription =
  "Syarat dan ketentuan penggunaan NuansaPulsa untuk transaksi produk digital, saldo, agent, marketing, dan kredit agent.";
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Syarat dan Ketentuan NuansaPulsa",
      },
    ],
  },
  twitter: {
