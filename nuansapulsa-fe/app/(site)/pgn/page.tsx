...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: "Cek dan bayar tagihan gas PGN di NuansaPulsa dengan langkah pembayaran yang ringkas.",
  path: "/pgn",
  keywords: ["bayar pgn online", "tagihan gas pgn", "cek tagihan pgn", "nuansapulsa"],
});
