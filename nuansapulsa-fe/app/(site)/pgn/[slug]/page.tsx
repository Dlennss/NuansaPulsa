...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Tagihan PGN | NuansaPulsa",
      description: "Cek dan bayar tagihan gas PGN di NuansaPulsa.",
      path: "/pgn",
    });
  }

  return buildPageMetadata({
    title: `${brand.nama} | Tagihan PGN NuansaPulsa`,
    description: `Cek dan bayar tagihan ${brand.nama} di NuansaPulsa dengan proses yang ringkas.`,
    path: `/pgn/${slug}`,
    keywords: [`tagihan ${brand.nama.toLowerCase()}`, `bayar ${brand.nama.toLowerCase()}`, "pgn online", "nuansapulsa"],
  });
}
