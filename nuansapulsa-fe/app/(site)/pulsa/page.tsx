...
export const metadata: Metadata = buildPageMetadata({
  title: "Pulsa Semua Operator | NuansaPulsa",
  description: "Isi pulsa Telkomsel, Indosat, XL, Axis, Smartfren, dan operator lain di NuansaPulsa dengan pilihan nominal yang jelas dan transaksi cepat.",
  path: "/pulsa",
  keywords: ["pulsa semua operator", "isi pulsa online", "pulsa telkomsel", "pulsa indosat", "nuansapulsa"],
});
