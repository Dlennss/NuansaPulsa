...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: "Cek dan bayar tagihan HP pascabayar di NuansaPulsa dengan pilihan operator yang jelas.",
  path: "/hp-pascabayar",
  keywords: ["hp pascabayar", "bayar tagihan hp", "tagihan telepon seluler", "nuansapulsa"],
});
